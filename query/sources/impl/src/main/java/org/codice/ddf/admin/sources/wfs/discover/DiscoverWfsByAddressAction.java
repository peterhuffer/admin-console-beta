...
import org.codice.ddf.admin.sources.wfs.utils.WfsSourceUtils;
...
public class DiscoverWfsByAddressAction extends BaseAction<SourceInfoField> {
    ...
    public SourceInfoField performAction() {
        ...
        DiscoveredUrl discoveredUrl = wfsSourceUtils.discoverWfsUrl(addressField.hostname(),
                addressField.port(),
                un,
                pw);
        ...
        DiscoveredUrl anotherOne = wfsSourceUtils.getPreferredWfsConfig(testUrl, un, pw);
