...
public class DeleteOpenSearchConfiguration extends BaseAction<SourceInfoField> {
    ...
    public SourceInfoField persist() {
        ...
        OperationReport report = configurator.commit("Deleted OpenSearch source with pid [{}].",
                servicePid.getValue());
        ...
        sourceInfoField.configuration(servicePropsToOpenSearchConfig(configToDelete));
