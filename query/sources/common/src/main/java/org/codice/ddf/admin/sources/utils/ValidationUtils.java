...
// TODO: 4/13/17 this class does not belong in this commons
public class ValidationUtils {
    ...
    public static List<Message> validateString(String strToCheck, String fieldId) {
        List<Message> errors = new ArrayList<>();
        if (StringUtils.isBlank(strToCheck)) {
            errors.add(DefaultMessages.emptyFieldError(fieldId));
        }
        return errors;
    }
    ...
    //            String configId) {
    //        List<ConfigurationMesscage> errors = validateString(strToCheck, configId);
    //        if (errors.isEmpty()) {
